...
$foods_cats = new Food("Felix Le Ghiottonerie","Bustine di umido","15",3,0,$dogs);
$foods_dogs = new Food("Sensitive","crochette per cani","15",7,0,$dogs);
$toys_cats = new Toys("Topino","Pupazzo topo","20",5,0,$cats);
$toys_dogs = new Toys("Pallina","Palla gatto","20",5,0,$dogs);
...
echo "PRODUCTSSSSS <br>";

var_dump($product->category->name);
?>